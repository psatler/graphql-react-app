...
const {
  ...
  GraphQLInt,
  GraphQLList,
  GraphQLNonNull //adding this so we can specify to not accept non null values
} = graphql;
...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    ...
    books: {
      ...
      resolve(parent, args) {
        // return books;
        return Book.find({}); //passing an empty object we don't specfy any criteria, so it'll return all books
      }
    },
    authors: {
